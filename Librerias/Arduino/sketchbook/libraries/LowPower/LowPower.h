...
class LowPowerClass
{
	public:
			...
			void powerDown_off(period_t period, adc_t adc, bod_t bod, timer2_t timer2,timer1_t timer1, timer0_t timer0, spi_t spi, usart0_t usart0,twi_t twi);
			void powerDown_on(adc_t adc, bod_t bod, timer2_t timer2,timer1_t timer1, timer0_t timer0, spi_t spi, usart0_t usart0,twi_t twi);
